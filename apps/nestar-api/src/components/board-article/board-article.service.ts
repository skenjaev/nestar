...
export class BoardArticleService {
  ...
  //   try {
  //     // 🛑 1. Shu user shu sarlavha bilan article yozganmi? Tekshir!
  //     const exist = await this.boardArticleModel.findOne({
  //       memberId,
  ...
  //         'Bu sarlavha bilan siz allaqachon article yaratgansiz.',
  //       );
  //     }

  //     // ✏️ 2. Yangi maqola yaratamiz
  //     const result = await this.boardArticleModel.create(input);

  //     // 📈 3. Member statistikasi oshiriladi
  ...
  public async updateBoardArticleByAdmin(
    ...
    // ❗️ Agar maqola o‘chirilib yuborilgan bo‘lsa — user statistikasi yangilanadi
    if (articleStatus === BoardArticleStatus.DELETE) {
      await this.memberService.memberStatsEditor({
        _id: result.memberId,
        targetKey: 'memberArticles',
